...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Updates", url="https://t.me/Cartoonworldtelugu_india"),
        InlineKeyboardButton("💬 Support", url="https://t.me/+6LCsmRJam5djYzZl")],
        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/Vamsi_2008_vamsi")]
        ])
        ...
        if value < file.file_size:
            ...
            if STRING_SESSION:
                ...
                if pre_check == True:
                    ...
                    uploadlimit(message.from_user.id, 6828129421)
